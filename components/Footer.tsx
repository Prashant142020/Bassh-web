...
export function Footer({ address, email, phone, socialLinks }: FooterProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              ...
              <Link href="/events" className="block hover:text-pink-500">
                Events
              </Link>
              <Link href="/gallery" className="block hover:text-pink-500">
                Gallery
              </Link>
